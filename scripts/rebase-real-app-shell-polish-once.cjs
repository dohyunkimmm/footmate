...
let design=read('src/v4/design-system-v2.css');
const density='\n/* Real App shell density polish */\n.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="home"],[data-screen="discover"],[data-screen="schedule"],[data-screen="profile"]) .fm-next-topbar{min-height:calc(64px + env(safe-area-inset-top))!important;padding-top:calc(8px + env(safe-area-inset-top))!important;padding-bottom:8px!important}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="discover"],[data-screen="schedule"],[data-screen="profile"])>.fm-next-topbar--titled{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr)}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="discover"],[data-screen="schedule"],[data-screen="profile"])>.fm-next-topbar--titled>:first-child{justify-self:start}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="discover"],[data-screen="schedule"],[data-screen="profile"])>.fm-next-topbar--titled>strong{justify-self:center}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="discover"],[data-screen="schedule"],[data-screen="profile"])>.fm-next-topbar--titled>:last-child{justify-self:end}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) [data-screen="discover"]>.fm-next-section{padding-top:20px!important}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) :is([data-screen="home"],[data-screen="discover"],[data-screen="schedule"],[data-screen="profile"]){padding-bottom:calc(86px + env(safe-area-inset-bottom))!important;scroll-padding-bottom:calc(86px + env(safe-area-inset-bottom))}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) .fm-next-nav{bottom:max(10px,env(safe-area-inset-bottom))!important;padding:5px 7px!important;border-radius:20px!important}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) .fm-next-nav button{min-height:50px;gap:2px;border-radius:14px;font-size:10px}.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) .fm-next-nav-icon{width:32px;height:26px}@media(min-width:700px){.fm-next-page[data-mode="real"] .fm-next-app:not([data-embed="true"]) .fm-next-nav{bottom:10px!important}}\n';
if(!design.includes('/* Real App shell density polish */'))design+=density;
write('src/v4/design-system-v2.css',design);
