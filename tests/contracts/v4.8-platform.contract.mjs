...
const provider=createMemoryStorageProvider({
  [STORAGE_KEYS.session]:JSON.stringify({route:'home',setupComplete:true,region:'수원 · 영통',position:'MF',level:'중급',legacyFlag:'keep-me'}),
  [STORAGE_KEYS.decision]:JSON.stringify({savedMatchIds:['gwanggyo-2130']})
});
