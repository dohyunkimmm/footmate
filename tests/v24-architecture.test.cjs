...
test('v2.4 core funnel remains available as the v2.5 compatibility layer',()=>{
...
test('v2.4 presenter ownership is preserved under v2.5',()=>{
...
test('required check keys remain stable while v2.5 extends QA',()=>{
