...
test('v2.4 core funnel remains available as a compatibility layer under v2.7',()=>{
...
test('v2.4 presenter ownership is preserved under v2.7',()=>{
...
test('required check keys remain stable while v2.7 extends QA',()=>{
