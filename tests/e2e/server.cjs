...
const rewrites=new Map([['/','index.html'],['/index','index.html'],['/app','app.html'],['/demo','app.html'],['/demo.html','app.html'],['/demo-shell','app.html'],['/demo-source','app.html'],['/next','app.html'],['/index-source','index.html']]);
