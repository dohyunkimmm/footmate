...
const rewrites=new Map([['/','index.html'],['/index','index.html'],['/app','app.html'],['/beta','beta.html'],['/beta/operator','beta-operator.html'],['/demo','app.html'],['/demo.html','app.html'],['/next','app.html'],['/next.html','app.html']]);
...
server.listen(port,host,()=>console.log('FootMate test server serving '+root+' at http://'+host+':'+port));
