...
// Regression target: fresh MY keeps the title/action hierarchy without a redundant feature description.
...
test('fresh MY keeps its title and save action without a feature description',async({page})=>{
