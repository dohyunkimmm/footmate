...
async function openCaseStudy(page,viewport,index=0){
  ...
  await page.waitForFunction(()=>document.documentElement.dataset.footmateCaseStudyRelease==='5.1.1'&&document.documentElement.dataset.footmateCaseStudySections==='13'&&document.documentElement.dataset.footmateCaseStudyHeadingLanguage==='en'&&document.querySelectorAll('.slide:not([hidden])').length===13);
