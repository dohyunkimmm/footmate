...
Representative reviewed surfaces:
...
Baseline generation alone is not a PASS. Design System v2 is considered visually verified only after normal PR Browser E2E + axe runs the committed baselines in comparison mode successfully.
