...
function enhance(){
  ...
  if(cover){
    ...
    badge.setAttribute('aria-label','FootMate v2.0.0 Product Experience');
  ...
  if(validation&&!document.getElementById('fmV11ExperienceNote')){
    ...
    note.innerHTML='<b style="display:block;margin-bottom:5px;color:#EAF3FF;font-size:12px">v2.0.0 Product Experience</b>39개 화면의 제품 경험과 런타임 구조를 Product/Portfolio mode, v2 store/controller, 접근성·반응형·visual regression 기준으로 정리했습니다. 이전 Portfolio Freeze는 2026-09-12 검증 snapshot으로만 보존합니다.';
