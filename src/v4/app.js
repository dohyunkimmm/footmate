    ...
    return `<section class="fm-next-screen fm-next-screen--intro" data-screen="welcome">
      <div class="fm-next-intro">
        ...
        <div class="fm-next-intro-copy" style="transform:translateY(-44px)">
          ...
          <p data-welcome-ai-copy style="position:absolute;left:0;top:100%;margin:10px 0 0;color:#56655d;font-size:15px;font-weight:700;line-height:1.5;letter-spacing:-.02em">AI가 최고의 경기를 골라준다</p>
        </div>
        <div class="fm-next-actions">
          ...
          ${state.setupComplete?button('저장된 설정으로 바로 추천 보기','continue-home','primary',`style="height:54px;min-height:54px;padding:0 20px;border-radius:16px"`):''}
        </div>
      </div>
    </section>`;
  }
...
function homeView(){
  ...
  return `<section class="fm-next-screen" data-screen="home">
    ${topbar({actionHtml:'<span style="width:44px" aria-hidden="true"></span>'})}
    ${adaptiveContext()}
