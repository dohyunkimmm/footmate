...
(function(){
  ...
  const slides=[
    `<div class="fm-next-cover cover">
      ...
      <div class="fm-next-cover-visual" aria-label="FootMate AI 경기 검색 정적 미리보기"><div class="fm-next-cover-glow" aria-hidden="true"></div><div class="fm-next-cover-frame"><div class="fm-cs-static-preview fm-cs-ai-preview" role="img" aria-label="FootMate Real App AI 경기 검색 화면 정적 프리뷰"><div class="fm-cs-static-top"><span>FootMate</span><b>경기 찾기</b></div><div class="fm-cs-ai-head"><div><span>AI Match Assistant</span><em>AI ready</em></div><h3>원하는 경기를 문장으로 검색하세요.</h3><p>필터와 함께 사용해 시간·거리·가격·포지션 조건을 빠르게 좁힐 수 있어요.</p></div><div class="fm-cs-ai-label">찾고 싶은 경기 조건</div><div class="fm-cs-ai-input"><span>8시 이후, 2만원 이하, 가까운 중급 MF 경기</span><b>AI 검색</b></div><div class="fm-cs-ai-examples"><span>8시 이후 · 2만원 이하</span><span>인계 · 초중급</span><span>20분 이내 · GK</span></div><div class="fm-cs-ai-status"><b>자연어로 조건을 입력해보세요.</b><span>AI는 요청을 검색 조건으로 바꾸고, 경기 순위는 추천 엔진이 결정합니다.</span></div><div class="fm-cs-ai-guardrail">AI는 참가·결제를 실행하지 않습니다.</div></div></div><div class="fm-next-cover-note"><strong>정적 AI 검색 프리뷰</strong><span>Real App의 AI 경기 검색 화면입니다.</span></div></div>
    </div>`,
