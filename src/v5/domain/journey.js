...
export const CONNECTED_PLATFORM_VERSION='5.1.0';
...
export const DOMAIN_OWNERSHIP=Object.freeze({
  ...
  participation:PARTICIPATION_DOMAIN,
  matchday:MATCHDAY_DOMAIN,
...
export function evaluateJourneyConsistency(candidate={}){
  ...
  return Object.freeze({
    ...
    domains:Object.freeze({recommendation,participation,matchday,return:returnState})
  });
}
